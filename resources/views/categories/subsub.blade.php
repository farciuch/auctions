<x-layout>
    <section>
        <p class="mt-4 text-m text-gray-500 font-bold">
            ...
            <a href="{{ route('subCategory.show', [$mainCategory->id, $subCategory->id]) }}" class="mt-4 text-m text-blue-300 hover:underline">{{ $subCategory->name }}</a> >
            <a href="{{ route('subSubCategory.show', [$mainCategory->id, $subCategory->id, $subSubCategory->id]) }}" class="mt-4 text-m text-blue-300 hover:underline">{{ $subSubCategory->name }}</a>
          </p>
        <h1 class="text-3xl font-bold px-3 mb-3 mt-3 text-center">{{ $subSubCategory->name }}</h1>
        <div class="border-solid border-2 border-black/20 p-4 text-center mt-2"> 
            ...
            <form method="GET" action="{{ route('subSubCategory.show', [$mainCategory->id, $subCategory->id, $subSubCategory->id]) }}">
                <div class="form-row">
                ...
                <a href="{{ route('subSubCategory.show', [$mainCategory->id, $subCategory->id, $subSubCategory->id]) }}">
