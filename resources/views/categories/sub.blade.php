<x-layout>
    <section>
        ...
        <h1 class="text-3xl font-bold px-3 mb-3 mt-3 text-center">{{ $subCategory->name }}</h1>
        <div class="border-solid border-2 border-black/20 p-4 text-center"> 
            @foreach($subCategory->subSubCategories as $subSubCategory)
            <ul>
                <a href="{{ route('subSubCategory.show', [$mainCategory->id, $subCategory->id, $subSubCategory->id]) }}" >{{ $subSubCategory->name }}</a>
            </ul>
            @endforeach
        </div>
        <div class="border-solid border-2 border-black/20 p-4 text-center mt-2"> 
            ...
            <form method="GET" action="{{ route('subCategory.show', [$mainCategory->id, $subCategory->id]) }}">
                <div class="form-row">
                ...
                <a href="{{ route('subCategory.show', [$mainCategory->id, $subCategory->id]) }}">
