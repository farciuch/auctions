    ...
    <section>
        ...
        <div class="mb-6">
            ...
            <div class="border-solid border-2 border-black/20 p-4">
                ...
                <a href="{{ route('items.edit', ['itemId' => $item->id, 'quantity' => $quantity]) }}" ><button class=" p-2 mt-2 bg-blue-500 text-white rounded">Zmień dane</button></a>
            </div>
        </div>
                ...
                <a href="{{ route('items.show', $item->id) }}">
                    <div class="border p-2 rounded-lg">
                        ...
                        <div class="flex justify-between">
                            ...
                            <div class="flex justify-center">
                                <p>Cena: {{ number_format($item->price, 2) }} PLN</p>
                            </div>
                        </div>
                    </div>
                </a>
        ...
        <div class="mb-6 border-solid border-2 border-black/20 p-4">
            ...
            <form action="{{ route('items.checkout.processSingle', $item->id) }}" method="POST">
                @csrf
