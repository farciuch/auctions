<x-layout>
    <section>
            ...
            <h1 class="text-3xl font-bold px-3 mb-3 mt-3 text-center">Kategorie</h1>
            <div class="border-solid border-2 border-black/20 p-4 text-center"> 
                @foreach ($categories as $category)
                    <div class="col-md-4">
                  
                        <a href="{{ route('mainCategory.show', $category->id) }}" class="main-category-button">{{ $category->name }}</a>
                    </div>
                @endforeach
            </div>
            ...
            @else
            <p class="text-red-500 py-5 text-xl">Brak wyników</p>
